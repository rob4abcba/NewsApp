...
public final class QueryUtils {
    ...
    private static List<News> extractFeatureFromJson(String newsJSON) {
        ...
        try {
            ...
            JSONArray newsArticleArray = responseObject.getJSONArray("results");

            // For each article in the newsArticleArray, create an {@link News} object
            for (int i = 0; i < newsArticleArray.length(); i++) {
                ...
                News articles = new News(articleTitle, sectionName, date, url);
